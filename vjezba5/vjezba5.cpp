...
{
    int brojIgraca;
    cout << "Unesite koliko zelite imati igraca? (2 ili 4)" << endl;
    cin >> brojIgraca;

    while (brojIgraca != 2 && brojIgraca != 4)
    {
        cout << "Pogresan broj igraca. Molimo unesite pravilan broj igraca (2 ili 4)" << endl;
        cin >> brojIgraca;
    }
    ...
    {
        igraci[i].akuziraj();
        cout << "Broj bodova igraca " << igraci[i].ime << ": " << igraci[i].broj_bodova << endl;
    }
}
